...
public class FatBurnSunWorkoutActivity extends AppCompatActivity {
    public static String TAG = "FatBurnSunWorkoutActivity";
    int position;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fat_burn_sun_workout);
...
//        }
        ...
        if(position == 0){
            ...
            gifImageView.setBackgroundResource(R.drawable.lunges);
            textView.setText(R.string.lunges);
            title.setText("LUNGES");
        }
        else if(position == 2){
            gifImageView.setBackgroundResource(R.drawable.burpees);
            textView.setText(R.string.burpees);
            title.setText("BURPEES");
        }
        else if(position == 3){
            ...
            gifImageView.setBackgroundResource(R.drawable.abdominal_crunches);
            textView.setText(R.string.abdominalcrunches);
            title.setText("ABDOMINAL CRUNCHES");
        }
        else if(position == 8){
            ...
            public void run()
            {
                ...
                if (running) {
                    ...
                    if(secondsStop == 30 && seconds == 10){
                        ...
                        seconds = 0;
                        mProgressBar.setVisibility(GONE);
                        Intent intent = new Intent(FatBurnSunWorkoutActivity.this, DoneScreen.class);
                        startActivity(intent);
