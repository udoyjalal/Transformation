...
public class FatBurnMonWorkoutActivity extends AppCompatActivity {
    public static String TAG = "FatBurnMonWorkoutActivity";
    int position;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fat_burn_mon_workout);
...
//        }
        ...
        if(position == 0){
            gifImageView.setBackgroundResource(R.drawable.skipping_without_rope);
            textView.setText(R.string.skippingwithoutrope);
            title.setText("SKIPPING WITHOUT ROPE");

        }
        else if(position == 1){
            gifImageView.setBackgroundResource(R.drawable.squat_pulses);
            textView.setText(R.string.squatpulses);
            title.setText("SQUAT PULSES");
        }
        else if(position == 2){
            gifImageView.setBackgroundResource(R.drawable.heel_touch);
            textView.setText(R.string.heeltouch);
            title.setText("HEEL TOUCH");
        }
        else if(position == 3){
            gifImageView.setBackgroundResource(R.drawable.flutter_kicks);
            textView.setText(R.string.flutterkicks);
            title.setText("FLUTTER KICKS");
        }
        else if(position == 4){
            gifImageView.setBackgroundResource(R.drawable.lateral_plank_walk);
            textView.setText(R.string.lateralplankwalk);
            title.setText("LATERAL PLANK WALK");
        }
        else if(position == 5){
            ...
            gifImageView.setBackgroundResource(R.drawable.plank_jacks);
            textView.setText(R.string.plankjacks);
            title.setText("PLANK JACKS");
        }
        else if(position == 7){
            ...
            public void run()
            {
                ...
                if (running) {
                    ...
                    if(secondsStop == 30 && seconds == 10){
                        ...
                        seconds = 0;
                        mProgressBar.setVisibility(GONE);
                        Intent intent = new Intent(FatBurnMonWorkoutActivity.this, DoneScreen.class);
                        startActivity(intent);
