...
import com.example.transformation.FatBurn.ActivityWorkoutDays.FatBurnMonWorkoutActivity;
...
public class FatBurnMonListActivity extends AppCompatActivity implements FatBurnAdapterAction{

    private static final String TAG = "FatBurnMonListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fatBurnDataModelList =  new ImageData().getMonData(this);
    ...
    public void addFatBurnAdapterAction(int index) {
        ...
        if(index == 0){
            Intent intent = new Intent(FatBurnMonListActivity.this, FatBurnMonWorkoutActivity.class);
