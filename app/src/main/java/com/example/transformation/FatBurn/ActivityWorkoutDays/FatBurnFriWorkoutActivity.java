...
public class FatBurnFriWorkoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fat_burn_fri_workout);
        // Hide the action bar
            ...
            public void run()
            {
                ...
                if (running) {
                    ...
                    if(secondsStop == 30 && seconds == 10){
                        ...
                        seconds = 0;
                        mProgressBar.setVisibility(GONE);
                        Intent intent = new Intent(FatBurnFriWorkoutActivity.this, DoneScreen.class);
                        startActivity(intent);
