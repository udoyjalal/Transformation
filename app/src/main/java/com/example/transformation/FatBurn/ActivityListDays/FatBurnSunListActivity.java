...
import com.example.transformation.FatBurn.ActivityWorkoutDays.FatBurnSunWorkoutActivity;
...
public class FatBurnSunListActivity extends AppCompatActivity implements FatBurnAdapterAction {

    private static final String TAG = "FatBurnSunListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fatBurnDataModelList =  new ImageData().getSunData(this);
    ...
    public void addFatBurnAdapterAction(int index) {
        ...
        if(index == 0){
            Intent intent = new Intent(FatBurnSunListActivity.this, FatBurnSunWorkoutActivity.class);
