...
public class FatBurnTuesWorkoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fat_burn_tues_workout);
        // Hide the action bar
            ...
            public void run()
            {
                ...
                if (running) {
                    ...
                    if(secondsStop == 30 && seconds == 10){
                        ...
                        seconds = 0;
                        mProgressBar.setVisibility(GONE);
                        Intent intent = new Intent(FatBurnTuesWorkoutActivity.this, DoneScreen.class);
                        startActivity(intent);
