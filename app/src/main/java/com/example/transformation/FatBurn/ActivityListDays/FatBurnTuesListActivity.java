...
import com.example.transformation.FatBurn.ActivityWorkoutDays.FatBurnTuesWorkoutActivity;
...
public class FatBurnTuesListActivity extends AppCompatActivity implements FatBurnAdapterAction {
    private static final String TAG = "FatBurnTuesListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fat_burn_tues_list);
        ...
        fatBurnDataModelList =  new ImageData().getTuesData(this);
    ...
    public void addFatBurnAdapterAction(int index) {
        ...
        if(index == 0){
            Intent intent = new Intent(FatBurnTuesListActivity.this, FatBurnTuesWorkoutActivity.class);
