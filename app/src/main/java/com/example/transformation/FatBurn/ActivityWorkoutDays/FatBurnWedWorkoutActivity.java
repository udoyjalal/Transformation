...
public class FatBurnWedWorkoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fat_burn_wed_workout);
        // Hide the action bar
...
//        }
        ...
        if(position == 0){
            ...
            gifImageView.setBackgroundResource(R.drawable.step_up_onto_chair);
            textView.setText(R.string.stepupontochair);
            title.setText("STEP UP ONTO CHAIR");
        }
        else if(position == 7){
            ...
            public void run()
            {
                ...
                if (running) {
                    ...
                    if(secondsStop == 30 && seconds == 10){
                        ...
                        seconds = 0;
                        mProgressBar.setVisibility(GONE);
                        Intent intent = new Intent(FatBurnWedWorkoutActivity.this, DoneScreen.class);
                        startActivity(intent);
